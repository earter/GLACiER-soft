...
def send_serial():
    ...
    with open(f"logs/log_{now}_send.csv", "a") as csvfile:
            csvfile.write(print_send_data)
...
def read_serial():
    while 1:
        ...
        with open(f"logs/log_{now}_read.csv", "a") as csvfile:
            csvfile.write(print_read_data)
